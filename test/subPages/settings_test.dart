...
void main() {
  ...
  testWidgets('Test Settings Tab', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MediaQuery(data: MediaQueryData(), child: MaterialApp(home: Scaffold(body: HomeController(pollingTime: 4, wifiConnection: false, addItem: null, changePollingTimer: null, removeItem: null, child: settings),)),));
