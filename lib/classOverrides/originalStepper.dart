...
/// Defines the [OriginalStepper]'s main axis.
enum StepperType {
...
/// A material step used in [OriginalStepper]. The step can have a title and subtitle,
...
@immutable
class Step {
  /// Creates a step for a [OriginalStepper].
  ///
...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
abstract class OriginalStepper extends StatefulWidget {
...
abstract class OriginalStepperState extends State<OriginalStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(OriginalStepper oldWidget) {
    ...
    return Stack(
      children: <Widget>[
        ...
        AnimatedCrossFade(
          ...
          secondCurve: const Interval(0.4, 1.0, curve: Curves.fastOutSlowIn),
          sizeCurve: Curves.fastOutSlowIn,
          crossFadeState: isCurrent(index) ? CrossFadeState.showSecond : CrossFadeState.showFirst,
          duration: kThemeAnimationDuration,
        ),
      ],
    );
